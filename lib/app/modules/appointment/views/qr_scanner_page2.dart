...
//   QrScannerPage2({Key? key}) : super(key: key);

//   @override
//   State<QrScannerPage2> createState() => _QrScannerPage2State();
// }
...
//     '${DateTime.now().toIso8601String()}_onPermissionSet $p'.debugLog('_onPermissionSet');
//     if (!p) {
